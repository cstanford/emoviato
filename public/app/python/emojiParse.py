...
trends = api.trends_place(2459115) #worldwide search

with open("Trends.json",'w') as outfile:
	json.dump(trends, outfile, indent=2)

#writing top 5 trends to a text file
##########################################################################
...
def getTweetsFromTrends(trendName):
